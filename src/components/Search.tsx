                    ...
                    {filteredProducts.map((product, index) => (
                      ...
                      >
                        ...
                        <div className="relative z-10 flex items-center space-x-3 sm:space-x-4">
                          {product.image_url ? (
                            <div className="relative flex-shrink-0 bg-slate-50 rounded-lg sm:rounded-xl">
                              <OptimizedImage
                            ...
                            <div className="w-14 h-14 sm:w-18 sm:h-18 bg-gradient-to-br from-slate-100 to-slate-200 rounded-lg sm:rounded-xl flex items-center justify-center group-hover:from-blue-100 group-hover:to-purple-100 transition-all duration-300 flex-shrink-0">
                              <Package className="w-6 h-6 sm:w-8 sm:h-8 text-slate-400 group-hover:text-blue-500" />
                            </div>
                          )}
                          <div className="flex-1 min-w-0">
