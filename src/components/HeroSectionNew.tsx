  ...
  ({ onShopNowClick, onAddToCart, onQuickView }: HeroSectionProps) => {
    ...
    return (
      <>
        ...
        <section className="relative min-h-screen bg-gradient-to-br from-amber-50 via-white to-stone-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 overflow-hidden">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                ...
                <div className="text-center lg:text-left space-y-6 sm:space-y-8 order-2 lg:order-1">
                  ...
                  <div className="inline-flex items-center gap-3 px-4 py-2 bg-white dark:bg-slate-800 rounded-full border border-amber-300 dark:border-amber-600 shadow-lg">
                    <Star className="w-4 h-4 text-amber-500 fill-amber-500" />
                    <span className="text-sm font-medium text-slate-800 dark:text-slate-200">
                      Loved by many students
                    </span>
                    <span className="hidden sm:inline text-sm text-slate-700 dark:text-slate-300 font-somali">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-base sm:text-lg text-slate-700 dark:text-slate-300 max-w-xl mx-auto lg:mx-0 leading-relaxed">
                      ...
                      <span className="block mt-2 text-sm sm:text-base text-amber-700 font-medium">
                        ...
                        Accessories
                        <span className="text-xs text-slate-600 dark:text-slate-400 font-somali block mt-1">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                    ...
                    >
                      <div className="absolute inset-0 bg-gradient-to-r from-white/20 dark:from-white/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    ...
                    <button
                      ...
                      className="group bg-white dark:bg-slate-700 text-slate-700 dark:text-slate-200 px-6 sm:px-8 py-3 sm:py-4 rounded-2xl hover:bg-amber-50 dark:hover:bg-slate-600 transition-all duration-300 font-semibold text-base sm:text-lg border-2 border-slate-300 dark:border-slate-600 hover:border-amber-500 dark:hover:border-amber-600 shadow-lg hover:shadow-xl transform hover:scale-105 active:scale-95"
                    >
                      <span className="group-hover:text-amber-700 dark:group-hover:text-amber-400 transition-colors duration-300">
                        Browse Products •{" "}
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start space-y-2 sm:space-y-0 sm:space-x-6 text-sm text-slate-700 dark:text-slate-300">
                  ...
                  <div className="text-center lg:text-left">
                    <div className="inline-flex items-start space-x-2 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 px-4 py-3 rounded-2xl text-sm border border-slate-300 dark:border-slate-600 shadow-sm max-w-sm">
                      <MapPin className="w-4 h-4 text-amber-600 mt-0.5 flex-shrink-0" />
                      <div>
                        <div className="font-somali">
                          Juja B Tower, Muratina Street, Eastleigh, Nairobi
                        </div>
                        <div className="text-xs text-slate-700 dark:text-slate-300 mt-1 font-arabic text-accent-lang">
              ...
              <div className="mt-12 lg:mt-16 grid grid-cols-3 gap-4 sm:gap-8">
                <div className="text-center bg-white dark:bg-slate-800 rounded-2xl p-4 sm:p-6 border border-slate-200 hover:border-amber-300 dark:border-amber-600 hover:bg-amber-50 transition-all duration-300 shadow-lg">
                  ...
                  <div className="text-[10px] sm:text-xs text-slate-700 dark:text-slate-300 font-somali">
                    Buugaag Diyaar
                  </div>
                </div>
                <div className="text-center bg-white dark:bg-slate-800 rounded-2xl p-4 sm:p-6 border border-slate-200 hover:border-amber-300 dark:border-amber-600 hover:bg-amber-50 transition-all duration-300 shadow-lg">
                ...
                <div className="text-center bg-white dark:bg-slate-800 rounded-2xl p-4 sm:p-6 border border-slate-200 hover:border-amber-300 dark:border-amber-600 hover:bg-amber-50 transition-all duration-300 shadow-lg">
                  ...
                  <div className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 font-somali">
                    Taageero
                  </div>
          ...
          <div className="relative bg-white dark:bg-slate-800 border-t border-slate-200">
