...
class FeedbackManager {
  ...
  private async playSound(frequency: number, duration: number, volume: number = 0.1) {
  ...
  async triggerFeedback(type: 'success' | 'error' | 'warning' | 'info', options: FeedbackOptions = {}) {
    const {
      enableSound = true,
...
export const playFeedback = {
  success: (options?: FeedbackOptions) => feedbackManager.triggerFeedback('success', options),
  error: (options?: FeedbackOptions) => feedbackManager.triggerFeedback('error', options),
  warning: (options?: FeedbackOptions) => feedbackManager.triggerFeedback('warning', options),
  info: (options?: FeedbackOptions) => feedbackManager.triggerFeedback('info', options),
};
